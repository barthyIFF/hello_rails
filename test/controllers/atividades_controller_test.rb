...
class AtividadesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create atividade" do
    assert_difference('Atividade.count') do
      post atividades_url, params: { atividade: { data: @atividade.data, distancia: @atividade.distancia, fim: @atividade.fim, inicio: @atividade.inicio, titulo: @atividade.titulo, user_id: @atividade.user_id } }
    end
  ...
  test "should update atividade" do
    patch atividade_url(@atividade), params: { atividade: { data: @atividade.data, distancia: @atividade.distancia, fim: @atividade.fim, inicio: @atividade.inicio, titulo: @atividade.titulo, user_id: @atividade.user_id } }
